...
from app.schemas.usuario import UsuarioCreate, UsuarioRead # Importamos los esquemas de Pydantic que definimos en usuario.py para validar los datos de entrada y salida de nuestras rutas.
